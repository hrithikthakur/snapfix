...
- `https://storage.googleapis.com/flickfix-downloads/flickfix-0.1.0-x64.dmg`

## Current Files

- `dist/flickfix-0.1.0-arm64.dmg` ✓ (already has arch)
- `dist/flickfix-0.1.0.dmg` ✗ (needs to be renamed to `-x64`)
...
mv dist/flickfix-0.1.0.dmg dist/flickfix-0.1.0-x64.dmg

# Upload both with consistent naming
gsutil cp dist/flickfix-0.1.0-arm64.dmg gs://flickfix-downloads/
gsutil cp dist/flickfix-0.1.0-x64.dmg gs://flickfix-downloads/
