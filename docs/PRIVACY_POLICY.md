...
This policy is written to meet the UK GDPR transparency expectations for privacy information.
...
We aim to collect **no behavioural analytics by default**. If you contact us for support, or if you choose to send diagnostics, we may process:

* your email address (if you email us)
* app version, OS version, and device details needed to debug
* crash or error logs (which typically include technical details like stack traces)

We do not intend to collect the content you selected for correction as part of diagnostics. If you send us screenshots or logs manually, please avoid including sensitive personal data.
...
Gemini API terms also include important restrictions (including age requirements and regional requirements).

---

## 7) International data transfers

Because text is processed by Google, your data may be processed in countries outside the UK. Google's Gemini API documentation and terms describe how the service operates, including abuse monitoring practices and retention.
...
## 14) Your data protection rights (UK)

Depending on your circumstances, you may have rights including access, correction, deletion, restriction, and objection.

To exercise your rights, contact us at: **[flickfix100@gmail.com](mailto:flickfix100@gmail.com)**.

You also have the right to complain to the UK supervisory authority, the **Information Commissioner's Office (ICO)**. ICO guidance highlights that people should be told they can complain to the ICO and given clear privacy information.

---

## 15) Changes to this policy

We may update this policy to reflect product changes, legal requirements, or improvements in how we explain things. We will update the "Last updated" date at the top, and publish the new version on our website.

---

## 16) Contact

Questions about privacy or this policy: **[flickfix100@gmail.com](mailto:flickfix100@gmail.com)**
