...
- **Linux** - Planned
- **macOS (Intel)** - Currently available via direct download
- **macOS (Apple Silicon)** - Currently available via direct download

## Privacy

We respect your privacy:
- We only collect your email address and platform preference
