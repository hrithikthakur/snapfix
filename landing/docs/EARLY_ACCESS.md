...
- Core grammar and spelling correction functionality
- Works across most macOS applications
- Fast response times with Gemini API
...
Send an email to **flickfix100@gmail.com** with:
...
- **Description**: What happened or what you'd like to see improved
